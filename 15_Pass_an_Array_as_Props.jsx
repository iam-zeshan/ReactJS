/*
We can pass an Arrays to the child components and then there we can access these arrays elements by using join method.
    ...
    render() {
      return (
        <div>
          ...
          <h2>Today</h2>
          { /* Change code below this line */ }
          <List tasks = {["Jyme", "meeting"]}/>
          <h2>Tomorrow</h2>
          <List tasks = {["Jyme", "meeting", "eating"]}/>
          { /* Change code above this line */ }
        </div>
      );
    }

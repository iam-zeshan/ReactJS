/*
When we submit the form in react component then, it refresh the page by default but we need to stop it from doing this by using an event.preventDefault method so in this way it will not gonna refresh the page. And we can set our state with the form submission.
